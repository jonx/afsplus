...
| [orphan-qualification.md](orphan-qualification.md) | Bounded open-unlinked identity, restartable cleanup, corruption rejection and open-target replacement | `cargo test -p afsplus-vfs --test api`; `cargo test -p afsplus-check --test orphans`; `make portable-c-gate` | M03, M05, M14 |
