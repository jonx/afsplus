...
| [conformance.md](conformance.md) | Versioned reference images decode to their expected output | `cargo test -p afsplus-check --test basic --test hardening --test mount_modes`; the versioned image corpus is an open deliverable | M00, M02, M05, M12 |
