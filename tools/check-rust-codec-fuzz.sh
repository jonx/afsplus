...
for target in tree-node bitmap-page region-descriptor snapshot-registry snapshot-record snapshot-lifetime snapshot-ledger snapshot-key reclaim-root reclaim-segment reclaim-table snapshot-checkpoint; do
