...
Present (L1 to L3): ABI version 1 with interface revision 9.
...
namespace changes, `ACTION_FH_FROM_LOCK`, `ACTION_CHANGE_MODE`, `ACTION_WRITE_PROTECT`, and at L3 `ACTION_EXAMINE_ALL`
