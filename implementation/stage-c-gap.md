...
Present (L1 to L3): ABI version 1 with interface revision 19.
...
`afsplus_aros_set_window_ops` (revision 19) bounds what a delayed window
holds, from the memory profile the handler already computes for
`CACHE=AUTO`.
