...
| M03 | RW core | Prototype complete — create/read/write/truncate/rename/replace/unlink/hard links on images by stable object ID; symlinks and open-unlinked orphans open | create/read/write/rename/unlink on images | [04](../docs/04-object-model.md), [05](../docs/05-directories-and-names.md), [06](../docs/06-files-and-extents.md), [07](../docs/07-allocation.md) | [crash-testing](../testing/crash-testing.md) |
| M04 | Journal | Prototype complete, format experimental — checkpoint COW plus intent log pass the every-write/every-flush crash matrices; wire formats unfrozen | exhaustive crash-point suite passes | [08](../docs/08-transactions-and-journal.md) | [crash-testing](../testing/crash-testing.md) |
...
| M07 | FS API v2 | Portable subset implemented — handle API with generation-bound directory cookies (ADR-039); 64-bit and capability test suite open | 64-bit and capability tests pass | [13](../docs/13-filesystem-api-v2.md) | [test-strategy](../testing/test-strategy.md) |
| M08 | FUSE | Complete — Mountable Alpha-0 composite gate accepted (ADR-060): macFUSE round trip, Hosted/native matrices, twelve replay cases; no hardware or freeze claim | same image read/write on host and AROS | [17](../docs/17-portability.md), [macos-fskit-activation](../docs/macos-fskit-activation.md) | [aros-system-volume-qualification](../testing/aros-system-volume-qualification.md) |
