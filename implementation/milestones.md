...
| M12 | Classic reader | Partial — heap-free C read plus delete/both rename modes compile for m68k; allocation, checkpoint and data writes open | constrained profile implementation demonstrated | [16](../docs/16-classic-systems.md) | [conformance](../testing/conformance.md) |
