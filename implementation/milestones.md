...
| M04 | Journal | Prototype complete, wire experimental — recovery, Rust adapters and C data/namespace views pass; hardware flushes and freeze open | exhaustive crash-point suite passes | [08](../docs/08-transactions-and-journal.md) | [crash-testing](../testing/crash-testing.md), [intent-log](../testing/intent-log-write-truncate-qualification.md) |
...
| M07 | FS API v2 | Portable subset — handles, directory cookies, logged fsync and reflinks pass; C has durable no-replace rename, broader capability suite open | 64-bit and capability tests pass | [13](../docs/13-filesystem-api-v2.md) | [test-strategy](../testing/test-strategy.md) |
...
| M12 | Classic reader | Partial — heap-free C reader plus first one-write/one-flush namespace mutation compile for m68k; full classic-rw open | constrained profile implementation demonstrated | [16](../docs/16-classic-systems.md) | [conformance](../testing/conformance.md) |
