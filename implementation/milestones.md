...
| M08 | FUSE | Partial — same-image operations and AROS matrices pass; macFUSE FSKit does not deliver host fsync before returning, so durability is reopened | same image read/write on host and AROS | [17](../docs/17-portability.md), [macos-fskit-activation](../docs/macos-fskit-activation.md) | [aros-system-volume-qualification](../testing/aros-system-volume-qualification.md) |
