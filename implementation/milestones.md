...
| M01 | Portable reader | Partial — C99 checkpoint reads and durable create/write/truncate log view pass with sanitizer corpus; namespace overlay, Unicode keys and complete corpus open | macOS/Linux/AROS builds, fuzz clean | [17](../docs/17-portability.md), [16](../docs/16-classic-systems.md) | [fuzzing](../testing/fuzzing.md), [conformance](../testing/conformance.md) |
...
| M04 | Journal | Prototype complete, wire experimental — recovery, Rust adapters and C data view pass; C namespace, hardware flushes and freeze open | exhaustive crash-point suite passes | [08](../docs/08-transactions-and-journal.md) | [crash-testing](../testing/crash-testing.md), [intent-log](../testing/intent-log-write-truncate-qualification.md) |
