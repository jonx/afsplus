...
| roadmap-55 | sparse-image create/mount/fork/replay workflow | [Stage D: portability and host tooling](../ROADMAP.md#stage-d-portability-and-host-tooling) | Partial — create, fork, mount, diff and session replay pass; replaying a scenario bundle onto a file image open | [image-workflow](../testing/image-workflow.md), [the gate](../tools/check-image-workflow.sh) |
