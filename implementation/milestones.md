...
| M04 | Journal | Architecture selected, format experimental — COW/group/log crash gates pass; write/truncate replay and wire freeze open | exhaustive crash-point suite passes | [08](../docs/08-transactions-and-journal.md) | [crash-testing](../testing/crash-testing.md) |
