...
| M03 | RW core | Prototype complete — stable-ID mutation plus `CloneFile`/`CloneRange` pass functional, checker and crash matrices; symlinks and open-unlinked orphans open | create/read/write/rename/unlink on images | [04](../docs/04-object-model.md), [05](../docs/05-directories-and-names.md), [06](../docs/06-files-and-extents.md), [07](../docs/07-allocation.md), [32](../docs/32-reflink-clone-semantics.md) | [crash-testing](../testing/crash-testing.md), [shared-extents](../testing/shared-extents-qualification.md) |
...
| M07 | FS API v2 | Portable subset implemented — handle API, generation-bound directory cookies and capability-gated file/range reflinks; broader 64-bit and capability suite open | 64-bit and capability tests pass | [13](../docs/13-filesystem-api-v2.md) | [test-strategy](../testing/test-strategy.md) |
