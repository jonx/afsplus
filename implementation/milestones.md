...
| M01 | Portable reader | Partial — Rust/AROS and C99 checkpoint-to-file reads with sanitizer corpus pass; C log replay, Unicode keys and complete corpus open | macOS/Linux/AROS builds, fuzz clean | [17](../docs/17-portability.md), [16](../docs/16-classic-systems.md) | [fuzzing](../testing/fuzzing.md), [conformance](../testing/conformance.md) |
