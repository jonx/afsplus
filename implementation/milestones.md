...
| M01 | Portable reader | Partial — Rust host/AROS plus C99 checkpoint/object/tree/file reads pass; C intent replay, Unicode key validation and fuzz corpus open | macOS/Linux/AROS builds, fuzz clean | [17](../docs/17-portability.md), [16](../docs/16-classic-systems.md) | [fuzzing](../testing/fuzzing.md), [conformance](../testing/conformance.md) |
