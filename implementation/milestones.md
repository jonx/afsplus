...
| M04 | Journal | Prototype complete, wire experimental — write/truncate and nested-recovery gates pass; VFS/C parity, hardware flushes and freeze open | exhaustive crash-point suite passes | [08](../docs/08-transactions-and-journal.md) | [crash-testing](../testing/crash-testing.md), [intent-log](../testing/intent-log-write-truncate-qualification.md) |
