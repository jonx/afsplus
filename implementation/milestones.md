...
| M04 | Journal | Prototype complete, wire experimental — Rust recovery/adapters and C namespace read/write gates pass; hardware flushes/freeze open | exhaustive crash-point suite passes | [08](../docs/08-transactions-and-journal.md) | [crash-testing](../testing/crash-testing.md), [intent-log](../testing/intent-log-write-truncate-qualification.md) |
...
| M07 | FS API v2 | Portable subset — handles, cookies, logged fsync and reflinks pass; C empty create/delete/both rename modes pass; broader suite open | 64-bit and capability tests pass | [13](../docs/13-filesystem-api-v2.md) | [test-strategy](../testing/test-strategy.md) |
...
| M12 | Classic reader | Partial — heap-free C read plus cached/8 KiB empty create/delete/both renames compile for m68k; allocation, checkpoint and data writes open | constrained profile implementation demonstrated | [16](../docs/16-classic-systems.md) | [conformance](../testing/conformance.md) |
