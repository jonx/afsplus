...
| roadmap-36 | explain APIs | [Stage B / B4. Core filesystem structures](../ROADMAP.md#b4-core-filesystem-structures) | Partial | [ExplainBlock, ExplainObject and ExplainPath against the checker, the bitmap, file bytes and the core's own answers](../crates/afsplus-check/tests/explain.rs), [the command](../crates/afsplus-tools/tests/explain_cli.rs); the remaining operations open |
