...
| M06 | AROS handler | Partial: DOS semantics + C ABI + packet translator + bounded trackdisk viewport; native handler shell pending | classic apps operate without recompilation |
