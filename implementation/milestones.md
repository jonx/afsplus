...
| M01 | Portable reader | Partial — C99 checkpoint and durable data/namespace views pass with seven-seed sanitizer corpus; Unicode keys and complete corpus open | macOS/Linux/AROS builds, fuzz clean | [17](../docs/17-portability.md), [16](../docs/16-classic-systems.md) | [fuzzing](../testing/fuzzing.md), [conformance](../testing/conformance.md) |
