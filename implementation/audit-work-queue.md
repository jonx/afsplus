...
| Repeated resource pressure | M03/M13; reclaim and sharing | Shared-survivor baseline and [24-cycle retained-view fixture](../testing/allocation-qualification.md#repeated-retained-view-pressure) | Preserve exact live/historical bytes and both-slot verification with one/eight-record scans; extend to aged multi-region sustained consumers and full memory accounting, building on the [phase-boundary RSS/read series](../testing/benchmark-contract.md#phase-boundary-resident-memory-and-repeated-reads) without treating a short read series as sustained qualification. |
