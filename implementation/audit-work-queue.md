...
| Internal diagnostic coverage | M01/M03, Stage A; common commit engine and replay harness | [Common checkpoint-tail ring](../testing/developer-harness.md#common-checkpoint-tail-flight-recorder), bounded storage and publication-failure tests | Extend [category selection and live callbacks](../testing/developer-harness.md#category-selection-and-live-diagnostics) across API-wide identities and allocator/tree/cache/intent-log/recovery events; extend the [versioned commit-tail replay export](../testing/developer-harness.md#internal-diagnostic-bundles) to those subsystems, selected-category/filtered counters and live-delivery observations; verify event loss and correlation under faults without changing filesystem outcomes. |
