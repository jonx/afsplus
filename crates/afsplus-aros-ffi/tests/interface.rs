...
fn sized_output_refuses_short_callers_and_never_writes_past_a_long_one() {
    ...
    assert_eq!(future.known.interface_revision, 16);
...
fn capabilities_use_published_c_identities_and_follow_the_volume() {
    ...
    // Bits 0,1,2,3,4,5,6,9,10,11,12,13,15,16,17 of api/filesystem_v2.h.
    assert_eq!(full.capabilities, 0x3_BE7F);
    ...
    assert_eq!(plain.capabilities, 0x3_C67F);
