...
//! ```text
//! offset size field
//! 0      1    op type (1 create, 2 delete, 3 rename)
//! 1      1    replace flag (rename)
//! 2      2    source/parent name length
//! 4      2    target name length (rename)
//! 6      2    extent count (create)
//! 8      8    parent / source-parent object ID
//! 16     8    target-parent object ID (rename)
//! 24     8    expected created object ID (create)
    ...
    pub fn decode(block: &[u8]) -> Result<LogRecord, FormatError> {
        ...
        for _ in 0..op_count {
            ...
            let variable = match op_type {
                1 => extent_count * EXTENT_WIRE + source_len,
                2 => source_len,
