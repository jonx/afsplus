...
| `data_eviction_cuts_four_pages_bounded_write`, `data_eviction_cuts_four_pages_bounded_shrink` | 4 | Every modeled cut of the spilled bounded write (12-write tail) and bounded shrink (11-write tail); 12,826 images | Full-COW write, hole reservation and reservation writes exceed the budget (13 to 15 writes); full shrink and growth cuts fall outside the per-test time budget |
