...
impl EventKind {
    ...
    pub const ALL: [EventKind; 64] = [
        Self::Begin,
        Self::DataWritesComplete,
        Self::MetadataDurable,
        Self::PublicationBegin,
        ...
        Self::VerifyFailed,
        Self::DataWriteBegin,
        Self::DataWriteComplete,
        Self::DataWriteFailed,
        Self::IntentDataDurable,
        Self::IntentEmptyFlush,
        Self::ViewReadBegin,
        Self::ViewReadComplete,
        Self::ViewReadFailed,
        Self::ViewMaintenanceFailed,
    ];

    /// The kind's stable code, published as `AFSP_EVENT_*` in
    /// `api/debug_observability.h` and carried by trace sinks and diagnostic
    /// bundles alike. Codes are appended and never reused; zero is none.
    pub const fn code(self) -> u16 {
        match self {
            Self::Begin => 1,
            Self::DataWritesComplete => 2,
            Self::MetadataDurable => 3,
            Self::PublicationBegin => 4,
            Self::CheckpointDurable => 5,
            Self::Adopted => 6,
            Self::Failed => 7,
            Self::ApiBegin => 8,
            Self::ApiSucceeded => 9,
            Self::ApiFailed => 10,
            Self::ApiUnwound => 11,
            Self::WindowOpened => 12,
            Self::WindowAttached => 13,
            Self::WindowLogBegin => 14,
            Self::WindowLogDurable => 15,
            Self::WindowLogFailed => 16,
            Self::WindowFailed => 17,
            Self::WindowClosed => 18,
            Self::WindowDetached => 19,
            Self::ObjectLookup => 20,
            Self::ObjectMapped => 21,
            Self::ObjectMissing => 22,
            Self::AllocationBegin => 23,
            Self::AllocationGranted => 24,
            Self::AllocationRetired => 25,
            Self::AllocationFailed => 26,
            Self::TreeReadBegin => 27,
            Self::TreeReadComplete => 28,
            Self::TreeSpillBegin => 29,
            Self::TreeSpillComplete => 30,
            Self::TreeIoFailed => 31,
            Self::ReclaimBegin => 32,
            Self::ReclaimPromoted => 33,
            Self::ReclaimBlocked => 34,
            Self::ReclaimAppended => 35,
            Self::ReclaimPlanned => 36,
            Self::ReclaimBuilt => 37,
            Self::ReclaimFailed => 38,
            Self::MountBegin => 39,
            Self::MountSelected => 40,
            Self::MountIntentBegin => 41,
            Self::MountIntentScanned => 42,
            Self::MountIntentReplayed => 43,
            Self::MountComplete => 44,
            Self::MountFailed => 45,
            Self::FormatBegin => 46,
            Self::FormatMetadataDurable => 47,
            Self::FormatPublicationBegin => 48,
            Self::FormatCheckpointDurable => 49,
            Self::FormatFailed => 50,
            Self::VerifyBegin => 51,
            Self::VerifyPhase => 52,
            Self::VerifyFinding => 53,
            Self::VerifyComplete => 54,
            Self::VerifyFailed => 55,
            Self::DataWriteBegin => 56,
            Self::DataWriteComplete => 57,
            Self::DataWriteFailed => 58,
            Self::IntentDataDurable => 59,
            Self::IntentEmptyFlush => 60,
            Self::ViewReadBegin => 61,
            Self::ViewReadComplete => 62,
            Self::ViewReadFailed => 63,
            Self::ViewMaintenanceFailed => 64,
        }
    }

    /// The kind of a stable code.
